...
classes = ["zCubwf", "hgKElc", "LTKOO sY7ric", "Z0LcW", "gsrt vk_bk FzvWSb YwPhnf", "pclqee", "tw-Data-text tw-text-small tw-ta",
           "IZ6rdc", "O5uR6d LTKOO", "v;zY6d", "webanswers-webanswers_table__webanswers-table","dDoNo ikb48b gsrt", "sXLaOe",
...
def System(command):
    ...
    def unmute():
        keyboard.press_and_release("volume unmute")  # Same key toggles mute/unmute

    def volume_up():
        for _ in range(5):  # 5 steps ≈ 10%
            keyboard.press_and_release("volume up")
            time.sleep(0.05)  # tiny delay for smooth action
...
async def TranslateAndExecute(commands: list[str]):
    ...
    for command in commands:
        ...
        if command.startswith("open "):
            if "open it" in command: pass
            if "open file" == command: pass
