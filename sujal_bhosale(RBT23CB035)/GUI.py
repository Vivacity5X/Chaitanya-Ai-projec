...
def SetMicrophoneStatus(Command):
    print(f"Setting microphone status to: {Command}")
...
def GetMicrophoneStatus():
    with open(TempDirectoryPath('Mic.data'), "r", encoding='utf-8') as file: 
        ...
        print(f"Microphone status retrieved: {Status}")
        return Status
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        self.restore_icon = QIcon(GraphicsDirectoryPath("maximize.png"))
        ...
        if GetMicrophoneStatus() == "True":
            try:
                ...
                try:
                    ...
                    ShowTextToScreen(query)  # Update the label
                    # You can also trigger MainExecution(query) here if needed
